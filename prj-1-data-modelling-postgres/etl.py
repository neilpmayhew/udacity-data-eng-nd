...
def process_log_file(cur, filepath):
    ...
    ## use dt attribute of pandas in a list comprehension to break the timestamp out into required date parts
    time_data = [[dt, dt.hour, dt.day, dt.week, dt.month, dt.year, dt.day_name()] for dt in t]
    column_labels = ('start_time', 'hour', 'day', 'week', 'month', 'year', 'weekday')
    
    ## Use pandas DataFrame from_records method to create a dataframe from time_data and column_labels
